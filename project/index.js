...
const readReportService = require('./services/readReport');
...
exports.handler = async (event) => {
    ...
    switch (true) {
        ...
        case event.httpMethod === 'GET' && event.path === readReport:
            response = await readReportService.readReport();
            break;
